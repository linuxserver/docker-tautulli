...
<!-- Please read https://github.com/linuxserver/docker-tautulli/blob/develop/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Ftautulli%2Fdevelop%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/tautulli/develop/index.html)
...
Simply pulling `lscr.io/linuxserver/tautulli:develop` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/tautulli:develop
```
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/tautulli:develop
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/tautulli:develop
    ```
...
* **15.12.22:** - Rebase develop branch to Alpine 3.17.
* **04.10.22:** - Rebase develop branch to Alpine 3.16, migrate to s6v3.
